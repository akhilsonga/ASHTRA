...
def Research_paper():
    ...
    file_path_docs = r"C:\Users\akhil\Downloads\Lablab\Lablab\pages\RAG\paper.pdf"
    #C:\Users\akhil\Downloads\Lablab\Lablab\pages\RAG
        ...
        try:
            with open(file_path, 'r') as file:
                if 'Start' in file.read():
                    ...
                    print("The word 'Start' is not found in the file. Waiting...")
...
def main():
    ...
    create_folder_if_not_exists(r".\Communication")
    create_file(r".\Communication\operate.txt", "Start")
...
Research Paper Title: The Societal and Transformational Impacts of Data Science. {paper_title}.
...
"""
        ...
        if exists:
            ...
            add = "Add a point that, do you know who wrote this paper?  they Akhil, Harsha, Tanmai they developed this podcast, and this is their paper. They have done a fantastic job "
